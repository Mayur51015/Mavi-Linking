      ...
      <div className="app-container">
        ...
        <React.Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/student/career-roadmap" element={
              <ProtectedRoute roles={['user', 'admin']}>
                <CareerRoadmap />
              </ProtectedRoute>
            } />
            <Route path="/dashboard/career-match" element={
              <ProtectedRoute roles={['user', 'admin']}>
                <CareerMatch />
              </ProtectedRoute>
            } />
            ...
            <Route path="/student/career-match" element={
              <ProtectedRoute roles={['user', 'admin']}>
                <CareerMatch />
              </ProtectedRoute>
            } />
            <Route path="/dashboard/career-lab" element={
              <ProtectedRoute roles={['user', 'admin']}>
                <CareerLab />
              </ProtectedRoute>
            } />
            <Route path="/career-lab" element={
              <ProtectedRoute roles={['user', 'admin']}>
                <CareerLab />
              </ProtectedRoute>
            } />
            <Route path="/student/career-lab" element={
              <ProtectedRoute roles={['user', 'admin']}>
                <CareerLab />
              </ProtectedRoute>
            } />
